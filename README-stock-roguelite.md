...
| Mega Rare | +5.0% | ±28.0% | Disruptors — positive EV but very volatile |
| Legendary | +1.0% | ±40.0% | Pre-revenue — break-even EV, wild swings |
| Ultra Legendary | −4.0% | ±55.0% | Deep speculative — mostly negative expected value |
| Unique | −8.0% | ±70.0% | Penny/moonshot — most tank; rare 5× outlier possible |
